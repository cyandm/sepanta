...
$service_categories = array_filter($service_categories, function ($category) {
                    ...
                    <div class="flex">
                        ...
                        <div class="flex-wrap flex gap-2 [&_div]:transition-all [&_div]:duration-200 [&_div_input]:cursor-pointer md:flex md:items-center">
                            ...
                            <div class="flex justify-center items-center gap-2 flex-wrap">
                                ...
                                <a href="<?php echo esc_url(get_post_type_archive_link('service')); ?>" class="bg-cynBlue text-white font-normal py-3 px-6 hover:bg-[#8186A9] rounded-4xl transition-all duration-300">
                                    همه
                                </a>

                                <?php foreach ($service_categories as $service_category) : ?>

                                    <a href="<?php echo esc_url(get_category_link($service_category->term_id)); ?>" class="bg-[#8186A9] text-white font-normal py-3 px-6 hover:bg-cynBlue rounded-4xl transition-all duration-300">
