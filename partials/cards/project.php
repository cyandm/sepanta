...
<a href="<?php the_permalink(); ?>" class="w-1/2 bg-white rounded-4xl flex md:first:[&>div>img]:rounded-tr-4xl md:last:flex-row-reverse md:last:[&>div>img]:rounded-bl-4xl md:[&:nth-last-child(2)]:flex-row-reverse md:[&:nth-last-child(2)]:[&>div]:rounded-br-4xl md:[&:nth-child(2)]:[&>div]:rounded-tl-4xl group max-md:w-full max-md:flex-col">
