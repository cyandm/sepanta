...
<a href="<?php the_permalink(); ?>" class="border border-cynLightBlue hover:border-cynBlue transition-all duration-300 rounded-3xl flex flex-col w-full">
    ...
    <div class="relative">
        ...
        <div class="absolute top-3 right-3 flex gap-2">
            ...
            <div class="px-5 py-1 rounded-2xl bg-white/20 backdrop-blur-md text-white flex flex-col items-center gap-1">
            ...
            <div class="px-2 py-1 rounded-2xl bg-white/20 backdrop-blur-md text-white flex flex-col items-center gap-1">
